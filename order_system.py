    ...
    while place_order:
        ...
        for food_category, options in menu.items():
            ...
            for meal, price in options.items():
                ...
                # using the print_menu_line function
                # Send the menu item number, food category, meal, and price as arguments
                print_menu_line(menu_selection, food_category, meal, price)
